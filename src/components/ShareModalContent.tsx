...
export const ShareModalContent = ({ roomId, roomName, onClose }: ShareModalContentProps) => {
  ...
  return (
    <div className="grid grid-rows-[1fr_auto] h-full max-h-[80vh] w-full max-w-md mx-auto">
      <div className="overflow-y-auto min-h-0">
        <div className="px-6 pt-6 pb-2">
          ...
          {/* QR Code */}
          <div className="bg-white p-4 rounded-lg shadow-sm shadow-purple-300 dark:shadow-current">
      ...
      <div className="px-6 pb-6 pt-2">
        <div className="flex gap-3 w-full pt-4 border-t border-gray-200 dark:border-gray-700">
