            ...
            <div className="flex items-center gap-2">
              ...
              {secondsTimer > 0 && (
                <button
                  ...
                  title="Resetar timer"
                >
                  <svg className="w-4 h-4 text-purple-500 hover:text-purple-600 dark:text-gray-100 dark:hover:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
