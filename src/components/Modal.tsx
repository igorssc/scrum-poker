...
export const Modal = ({ isOpen, onClose, title, children, className }: ModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-500 flex items-center justify-center p-4 h-dvh">
      {/* Backdrop */}
      ...
      <div
        className={twMerge(
          'relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full max-h-[90dvh] overflow-auto',
          className
        )}
      >
        {/* Header */}
